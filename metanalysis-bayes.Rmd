...
Missingness fenotypu - at random?
...
formula_gene_source_age <- brmsformula(phenotype_value ~ 1 + ((0 + phenotype)|gene) + ((0 + phenotype)||source) + (0 + age_mod||phenotype) + (0 + guess_age || ID_for_age) , family = "bernoulli")
