...
run_pp_checks(fit_gene_filtered_lof, data_long_filter_lof, types = c("age_phenotype","sex_phenotype", "source"))
...
fit_gene_source
run_pp_checks(fit_gene_source, data_long, types = c("sex_phenotype","age_phenotype", "gene_lof","phenotype_lof", "source"))
```
...
fit_gene_lof
run_pp_checks(fit_gene_lof, data_long, types = c("sex_phenotype","age_phenotype", "source"))
