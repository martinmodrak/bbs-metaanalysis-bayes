...
We see that for most phenotypes the results are mostly positive, so the family structure (and hence specific type of mutation and/or genetic background) plays some role above just knowing cLOF and the gene where the mutation occurs. 
