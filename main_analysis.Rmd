...
*This is Appendix 1 for the paper "Exploring the function of the BBSome using clinical data: Meta-analysis of genotype-phenotype associations in Bardet-Biedl Syndrome". The complete source code for the analysis can be found at https://github.com/martinmodrak/bbs-metaanalysis-bayes *
...
```{r}
plot_lof_differences_estimates(fit, data_for_prediction_BBSome)
plot_lof_differences_estimates(fit_base_model(models_base[["gene_source_lof_per_gene"]], data_long), data_for_prediction_BBSome)
```


# Evaluating conclusions

TODO vzít z multiverse
