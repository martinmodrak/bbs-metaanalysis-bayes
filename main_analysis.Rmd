...
data_long %>% filter(phenotype == "LIV", gene %in% c("BBS01","BBS02")) %>% group_by(gene) %>%
 summarise(prevalence = mean(phenotype_value), num_cases = n()) %>%
  kable()
