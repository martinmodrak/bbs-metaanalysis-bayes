...
data_for_prediction_gene_source_chaperonins <- data_for_prediction_gene_source %>% filter(functional_group_for_gene(gene) == "Chaperonins")


differences_chaperonins_plot <- plot_gene_phenotype_differences_estimates(fit_gene_source, data_for_prediction_gene_source_chaperonins, data_original = data_long)
differences_chaperonins_plot 
```

This is the same plot as for the BBSome genes, only shown the members of the chaperonins group.
