...
`loss_of_function` encodes the fact that the protein has certainly lost function (is truncated in both alleles). 
...
Let's look at comparison of BBS02 to prevalence across all other phenotypes:
...
There is one study that shows increase for BBS02 and one that shows decrease for BBS02. And the one showing decrease is actually the study with larger sample size. The difference seems to be driven by studies that have BBS01 patients and no or very few BBS02 patients and can thus be attributed to between-study variability.
