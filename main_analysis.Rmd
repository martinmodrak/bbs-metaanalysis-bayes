...
`loss_of_function` and `loss_of_function_certain` are different encodings of the fact that the protein has certainly lost function (is truncated in both alleles). 
