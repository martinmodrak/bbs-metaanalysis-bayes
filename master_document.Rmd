...
* Part 2 describes all Bayesian models we tried throughout this project and discusses the reasoning behind our choice of model for the main analysis, in particular why the between-study variability is crucial and taking into account the type of mutation (i.e. whether it is complete loss of function (cLOF)) useful while age, and sex can be omitted.
